...
@section('css')
   <script>
        if (screen.width <= 700) {
            document.location = "apply_mobile";
        }
    </script>
@endsection
@section('content')
                    ...
                    <div class="col-lg-9 content-area " style="">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="row">
                                ...
                                <input class="form-control" type="hidden" name="agent" value="{{$id ?? 1}}" style="border:solid 2px #761193;border-radius: 20px; ">
                                ...
                                <!--<div class="col-lg-6 mb-4">-->
                                <!--    <label class="label tx-bold text-dark">{{trans('main_tran.Image Id:')}}</label>-->
                                ...
                                <div class="col-lg-6 mb-4">
                                    <button class="btn btn-primary col-lg-12" type="submit">{{trans('main_tran.Apply')}}</button>
                                </div>

                                <div class="col-lg-6 ">
                                    <a class="btn btn-danger col-lg-12" id="add_more_fields">{{trans('main_tran.Add more member')}}</a>
                                </div>
                                    </div>
                                    </div>
                                </form>
