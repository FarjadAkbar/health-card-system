...
@section('css')
    ...
    <style>
        ...
        .rtl .dropdown-menu{
            ...
            text-align: {{trans('main_tran.text-align')}} !important;
        }
    </style>
@endsection
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="ttm-service-description">
                                        <h4>{{trans('main_tran.Search for a hospital or service and the area')}}</h4>
                                        <form class="form-group" method="post" action="{{route('hospital.directory.search')}}" autocomplete="off">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-10 col-8 {{trans('main_tran.dir')}}">
                                                    <input type="text" dir="{{trans('main_tran.dir')}}"  style="border:solid 2px #761193;border-radius: 20px; height: 40px " class="form-control typeahead" name="search" placeholder="{{trans('main_tran.Search for a hospital or service and the area')}}"  value="{{$hospital ?? ''}}" id="hospital">
                                                </div>
                                            ...
                                            @foreach($hospital2 as $h)
                                                <div class="ttm-box-col-wrapper col-lg-12 col-md-6 col-sm-12">
                                                    ...
                                                    <div class="featured-imagebox featured-imagebox-post ttm-box-view-left-image box-shadow row">
                                                        <div class="col-3 ttm-featured-img-left bg-white position-relative overflow-hidden">
                                                            <div class="position-absolute w-75" style="top: 50%; left: 50%; transform: translate(-50%, -50%);">
                                                        ...
                                                        <div class="col-lg-7 col-9 offset-lg-2 featured-content featured-content-post">
                                                            @if(App::getLocale()== 'en')
                                                    ...
                                                    <div class="featured-imagebox featured-imagebox-post ttm-box-view-left-image box-shadow row">
                                                        <div class="col-lg-5 col-3 ttm-featured-img-left">
                                                            <div class="ttm-post-featured-outer">
                                                                ...
                                                                <div class="d-flex justify-content-center align-items-center" style="height: 120px; background: #fff; width: 150px;">
                                                                    <a href="{{route('hospital.directory.profile',$h->id)}}">
                                                                        <img class="img-fluid" src="{{URL::asset('Attachments')}}/{{$h->id ?? ''}}/{{$h->Attachment->url_logo ??'' }}" alt="logo-hospital" style="width:100px; height:auto">
                                                                    </a>
                                                                </div>
...
@section('js')
    ...
    <script>
        ...
        $('#hospital').typeahead({
            source: function(query, process){
                return $.get(path, {query:query}, function(data){
                    if(onlyLettersNumberAndSpaces(query)){
                        return process(data);   
                    }
                    for (var i = 0; i < data.length; i++) {
                        result.push(data[i].name_ar);
                    }
        ...
        function onlyLettersNumberAndSpaces(str) {
            return Boolean(str.match(/^[A-Za-z0-9\s]*$/));
        }
