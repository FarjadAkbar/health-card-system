                            ...
                            <div class="layer-content">
                                ...
                                <div class="featured-icon-box iconalign-before-heading mb-25">
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-title">
                                            <h5>{{ $general_info->address_1 }}</h5>
                                            <h4>{{ $general_info->address_2 }}</h4>
                                        </div>
                                    </div>
                                </div><!-- featured-icon-box end-->
                                <!--featured-icon-box-->
                                ...
                                <div class="social-icons circle social-hover">
                                    <ul class="list-inline">
                                        <li class="social-facebook"><a class="tooltip-top" target="_blank" href="{{ $general_info->whatsapp }}" data-tooltip="WhatsApp"><i class="fa fa-whatsapp" aria-hidden="true"></i></a></li>
                                        <li class="social-linkedin"><a class=" tooltip-top" target="_blank" href="{{ $general_info->instagram }}" data-tooltip="Instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
