...
<div class="breadcrumb-header justify-content-between">
   <div class="my-auto">
      <div class="d-flex">
         <h4 class="content-title mb-0 my-auto">Email Templates</h4>
      ...
      <div class="card">
         <!-- <div class="card-header pb-0">
            <div class="col-sm-1 col-md-2">
               <a class="btn btn-primary btn-sm" href="{{ route('templates.create') }}">Add Template</a>
            </div>
         </div> -->
         <div class="card-body">
               ...
               <table class="table table-hover" id="example1" data-page-length='50'
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>{{ $template->mail_description }}</td>
                        <td>
                           @if ($template->status != 'promotional')
                           <span class="label text-success d-flex">
                              <div class="dot-label bg-success m-1"></div>
                        ...
                        <td>
                           <a href="{{ route('templates.show', $template->id) }}" class="btn btn-sm btn-warning"
                              title="تعديل"><i class="las la-eye"></i></a>
                           <a href="{{ route('templates.edit', $template->id) }}" class="btn btn-sm btn-info"
