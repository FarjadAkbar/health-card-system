...
<div class="breadcrumb-header justify-content-between">
   <div class="my-auto">
      <div class="d-flex">
         ...
         <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Edit Template
         </span>
      </div>
   </div>
</div>
   ...
   <div class="col-lg-12 col-md-12">
      ...
      <div class="card">
         <div class="card-body">
            ...
            <br>
            {!! Form::model($template, ['method' => 'PATCH','route' => ['templates.update', $template->id]]) !!}
            <!-- <div class="">
               <div class="row mg-b-20">
                  <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                     <label>Title: <span class="tx-danger">*</span></label>
                     <input class="form-control form-control-sm mg-b-20"
                        data-parsley-class-handler="#lnWrapper" name="title" required="" value="{{ $template->mail_title }}"
                        type="text">
                  </div>
                  <div class="col-lg-6">
                     <label class="form-label">Status</label>
                     <select name="status" id="select-beast"
                        class="form-control  nice-select  custom-select"  value="{{ $template->status }}">
                        <option value="promotional">Promotional</option>
                        @foreach($card as $c)
                           <option value="{{ $c->status }}"  {{ $template->status == $c->status ?? 'selected'}}>{{ ucfirst($c->status) }}</option>
                        @endforeach
                     </select>
                  </div>
               </div>
            ...
            <div class="row mg-b-20">
               <div class="parsley-input col-md-12 mg-t-20 mg-md-t-0" id="lnWrapper">
                  ...
                  <input class="form-control form-control-sm mg-b-20"
                     data-parsley-class-handler="#lnWrapper"  value="{{ $template->mail_subject }}"
            ...
            <div class="row mg-b-20">
               <div class="parsley-input col-md-12 mg-t-20 mg-md-t-0" id="lnWrapper">
                  ...
                  <input class="form-control form-control-sm mg-b-20"
                     data-parsley-class-handler="#lnWrapper"  value="{{ $template->mail_description }}"
            ...
            <div class="row row-sm mg-b-20">
               ...
               <input type="hidden" id="message" name="message" value="{{ $template->mail_body }}" />
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
               <button class="btn btn-main-primary pd-x-20" type="submit" onclick="formSubmitted()">Update</button>
            </div>
            {!! Form::close() !!}
         </div>
      </div>
