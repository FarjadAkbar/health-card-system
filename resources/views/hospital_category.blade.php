                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="ttm-service-description">
                                                        ...
                                                        <div class="ttm-post-featured-outer">
                                                            <div class="ttm-post-thumbnail featured-thumbnail">
                                                                <a href="{{route('hospital.directory.profile',$h->id)}}">
                                                                    <img class="img-fluid" src="{{URL::asset('Attachments')}}/{{$h->id ?? ''}}/{{$h->Attachment->url_logo ?? ''}}" alt="logo-hospital"  style="height:190px;width:350px;">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-lg-2 float-left justify-content-lg-end">
                                            {{$hospital->links()}}
