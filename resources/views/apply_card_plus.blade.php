                    ...
                    <div class="col-lg-9 content-area " style="">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="row">
                                ...
                                <form class="form-group" method="post" action="{{route('apply.add.plus')}}"
                                        ...
                                        <div class="row" style="background-color: whitesmoke;opacity: 0.9;">
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                ...
                                                <input class="form-control" type="text" name="name[]" placeholder="Name"
                                                       style="border:solid 2px goldenrod;border-radius: 20px; " required>
                                            </div>
                                            <div class="col-lg-6 mb-4">
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                ...
                                                <select style="border:solid 2px goldenrod;border-radius: 20px; "
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                ...
                                                <select style="border:solid 2px goldenrod;border-radius: 20px; "
                                                        class="form-control" name="package" required>
                                                    <option label="select one"></option>
                                            ...
                                            <div class="col-4 mb-4">
                                                ...
                                                <input style="border:solid 2px goldenrod;border-radius: 20px; "
                                            ...
                                            <div class="col-lg-12 mb-5" id="survey_options">
                                                ...
                                                <textarea style="border:solid 2px goldenrod;border-radius: 20px; "
