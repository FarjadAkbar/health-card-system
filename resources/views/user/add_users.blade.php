                    ...
                    <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                        ...
                        <div class="row row-sm mg-b-20">
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0">
                               ...
                               <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0">
                                <label>Hospital: <span class="tx-danger">*</span></label>
                                <select name="hospital_id" class="form-control">
                                    <option label="Select One"></option>
                                    @foreach(\App\Hospital::all() as $h)
                             ...
                             <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0">
                                <label>Group Company: <span class="tx-danger">*</span></label>
                                <select name="group_id" class="form-control">
                                    <option label="Select One"></option>
                                    @foreach(\App\Card::where('group_company', 1)->get() as $c)
