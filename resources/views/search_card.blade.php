                ...
                <div class="row" >
                    ...
                    <div class="col-lg-9 content-area" style="background-color: whitesmoke">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 mt-80" style="background-image: url({{URL::asset('assets/img/sama_card.jpg')}});background-size:contain; background-repeat: no-repeat; height:350px; ">
                                <div class="row">
                                    @if($card ?? '' ?? '')


                                    <div class="{{ $card->group_company && \App\Card::where('cpr_no', $card->father_id)->first()->img ? 'col-sm-3 mt-80' : 'col-lg-2'}} header">
