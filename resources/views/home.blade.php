...
<!--page start-->
<div class="page">
 <!--<script id='pixel-script-poptin' src='https://cdn.popt.in/pixel.js?id=f8dbf64d13fa0' async='true'></script> -->
    <!-- preloader start -->
    <div id="preloader">
        <div id="status">&nbsp;</div>
    </div>
        ...
        <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" data-version="5.4.8.1">
            <ul>
                ...
                <li data-index="rs-7" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="images/slides/slider-mainbg-002.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <a class="tp-caption skin-flat-button tp-resizeme" style="background-color:white;color:  #761193;" href="{{route('apply.view')}}" target="_self" id="slide-7-layer-6" data-x="['center','center','center','center']" data-hoffset="['449','361','256','0']" data-y="['top','top','top','top']" data-voffset="['432','425','226','235']"
                    ...
                    <a class="tp-caption  tp-resizeme" style="background-color:white;color:  #761193;" href="{{route('hospital.directory')}}" target="_self" id="slide-7-layer-13" data-x="['center','center','center','center']" data-hoffset="['195','125','36','0']" data-y="['top','top','top','top']" data-voffset="['432','425','225','180']"
                       data-fontsize="['13','13','13','12']"
                                    ...
                                    <div class="featured-icon-box top-icon style4 text-center">
                                        <div class="featured-icon-box-inner">
                                            ...
                                            <div class="featured-content">
                                                ...
                                                <div class="ttm-di_links">
                                                    <a href="{{route('be_partner_apply')}}" class="di_link">
                                                        <i class="fa fa-angle-right"></i>
                                                    </a>
                                                </div>
                                            </div>
                ...
                <div class="row">
                    <div class="wrap-team team-slide owl-carousel" data-item="4" data-nav="true" data-dots="false" data-auto="false">
                        ...
                        <div class="featured-imagebox featured-imagebox-team ttm-team-box-view-overlay">
                            ...
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                                    <h5><a href="#">Alsalam Specialist Hospital</a></h5>
                                </div>
                            </div>
                        </div><!-- featured-imagebox-team end-->
                        ...
                        <div class="featured-imagebox featured-imagebox-team ttm-team-box-view-overlay">
                            ...
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                                    <h5><a href="#">Al Kindi Specialised Hospital</a></h5>
                                </div>
                            </div>
                        </div><!-- featured-imagebox-team end-->
