        ...
        <div class="container">
            <div class="ttm-topbar-content">
                <ul class="top-contact text-left">
                    <li><i class="themifyicon ti-location-pin" style="color: white"></i>
                        {{\App\GeneralInfo::first()->address_1}}, {{\App\GeneralInfo::first()->address_2}}
                    </li>
                    <li><i class="themifyicon ti-timer" style="color: white"></i>
                        {{\App\GeneralInfo::first()->closing}}
                    </li>
                </ul>
                <div class="topbar-right text-right">
                    <div class="ttm-social-links-wrapper list-inline">
                        <ul class="social-icons">
                            <li><a href="{{\App\GeneralInfo::first()->whatsapp}}"><i class="fa fa-instagram"></i></a>
                            </li>
                            <li><a href="{{\App\GeneralInfo::first()->instagram}}"><i class="fa fa-whatsapp"></i></a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="site-branding">
                            <a class="home-link" href="{{route('home_page')}}" title="Sama Card" rel="home">
                                <img id="logo-img" class="img-center"
                                     src="{{URL::asset('company')}}/{{\App\GeneralInfo::first()->logo}}" alt="logo-img">
                            </a>
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li><a href="#">{{trans('main_tran.Join us')}}</a>
                                        <ul>
                                            ...
                                            <li><a href="{{route('be_partner_apply')}}">{{trans('main_tran.Be A Partner')}}</a>
                                            </li>
                                            <li>
