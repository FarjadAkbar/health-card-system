                                    ...
                                    <td>
                                      ...
                                      <a class="modal-effect btn btn-sm btn-danger"
                                        ...
                                        @endcan
                                           ...
                                           data-id="{{$h->id}}" data-name="{{$h->name}}"
                                           data-toggle="modal"
                                           href="#modaldem11233" title="delete"><i class="las la-user-circle"></i> Stakeholder</a>
                                        @can('edit-hospital')
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                           data-id="{{$h->id}}" data-name="{{$h->name}}" data-name_ar="{{$h->name_ar}}"
                                           data-contract="{{$h->contract_date}}"
                                           data-provider_name = "{{$h->provider_type}}" data-card_type = "{{$h->card_type}}"
                                           data-expiry="{{$h->expiry_date}}" data-cr="{{$h->cr_no}}"
                                           data-place="{{$h->place}}"
                                        ...
                                        <a class="modal-effect btn btn-sm btn-primary"
                                           ...
                                           data-id="{{$h->id}}" data-name="{{$h->name}}"
                                           data-toggle="modal"
                                           href="#modaldem2" title="status"><i class="fas fa-sync-alt"></i> Status</a>
                                            @endcan
                                            @can('edit-online')
                                           ...
                                           data-id="{{$h->id}}" data-name="{{$h->name}}"
                                           data-toggle="modal"
                                           href="#modaldem21" title="Online-Offline"><i class="fas fa-plug"></i> On-Off</a>
                                            @endcan
                                            @can('add-service')
                                        <a class="modal-effect btn btn-sm btn-danger"
                                           data-effect="effect-scale"
                                           data-id="{{$h->id}}" data-name="{{$h->name}}"
                                           data-toggle="modal"
                                           href="#modaldem22" title="Services"><i class="far fa-hospital"></i> Services</a>
                                            @endcan
                                            @can('logo')
                                           ...
                                           data-id="{{$h->id}}" data-name="{{$h->name}}"
                                           data-toggle="modal"
                                           href="#modaldemlo" title="Logo"><i class="far fa-images"></i> Logo</a>
                                           
                                                         <a class="modal-effect btn btn-sm btn-success"
                                           data-effect="effect-scale"
                                           data-id="{{$h->id}}" data-name="{{$h->name}}"
                                           data-toggle="modal"
                                           href="#modaldemlo001" title="Logo"><i class="far fa-images"></i> Gallery</a>
                                            @endcan
                                            @can('contract')
<a class="modal-effect btn btn-sm btn-warning"
                                           ...
                                           data-id="{{$h->id}}" data-name="{{$h->name}}"
                                           data-toggle="modal"
                                           href="#modaldemlo122" title="contract"><i class="fas fa-file-signature"></i> Contract</a>
                                            @endcan
                                            @can('doctor-list')
                                           ...
                                           data-id="{{$h->id}}" data-name="{{$h->name}}"
                                           data-toggle="modal"
                                           href="#modaldemlod" title="pdf"><i class="far fa-file-pdf"></i> Doctors List</a
                                            @endcan
                                    </td>
                    ...
                    @csrf
                     <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <label class="label">Contract Date</label>
                                <input type="date" value="{{date('Y-m-d')}}" class="form-control" name="contract_date" >
                            </div>
        ...
        <!-- Internal Modal js-->
            ...
            <script type="text/javascript">
                $('#modaldemo99').on('show.bs.modal', function (e) {
                    ...
                    var provider_type = $(e.relatedTarget).data('provider_name');
                    var card_type = $(e.relatedTarget).data('card_type');
...
console.log(provider_type);
                    ...
                    $(e.currentTarget).find('textarea[name="provider_name2"]').val(provider_type);
                    $(e.currentTarget).find('textarea[name="card_type"]').val(card_type);
                });
            </script>
                <script type="text/javascript">
                $('#modaldem11233').on('show.bs.modal', function (e) {
