...
<div class="breadcrumb-header justify-content-between">
   <div class="my-auto">
      <div class="d-flex">
         <h4 class="content-title mb-0 my-auto">Provider </h4>
         <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Profile</span>
      </div>
   </div>
   <div class="d-flex my-xl-auto right-content">
      <div class="pr-1 mb-3 mb-xl-0">
         <a class="modal-effect btn btn-primary btn-md btn-block" data-effect="effect-super-scaled"
            data-toggle="modal" href="#modaldemo99"><i class="fas fa-edit"></i> Edit</a>
      </div>
      <div class="pr-1 mb-3 mb-xl-0">
         <a class="modal-effect btn btn-danger btn-md btn-block" data-effect="effect-super-scaled"
            data-toggle="modal" href="#modaldemlo"><i class="fas fa-image"></i> Logo</a>
      </div>
      <div class="pr-1 mb-3 mb-xl-0">
         <a class="modal-effect btn btn-success btn-md btn-block" data-effect="effect-super-scaled"
            data-toggle="modal" href="#modaldemlo122"><i class="fas fa-file-contract"></i> contract</a>
      </div>
      <div class="pr-1 mb-3 mb-xl-0">
         <a class="modal-effect btn btn-dark btn-md btn-block" data-effect="effect-super-scaled"
            data-toggle="modal" href="#modaldem21"><i class="fas fa-file-contract"></i> On/Off</a>
      </div>
      <div class="pr-1 mb-3 mb-xl-0">
         <a class="modal-effect btn btn-purple btn-md btn-block" data-effect="effect-super-scaled"
            data-toggle="modal" href="#modaldemlo001"><i class="fas fa-images"></i> Gallery</a>
      </div>
   </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="pl-0">
               <div class="main-profile-overview">
                  <div class="main-img-user profile-user">
                     <img alt=""
                        src="{{ URL::to('Attachments')}}/{{$attachment_logo->hospital_id ?? ''}}/{{$attachment_logo->url_logo ?? ''}}"><a
                  ...
                  <div class="main-profile-social-list">
                     ...
                     <div class="media">
                        <a href="https://api.whatsapp.com/send?phone=973{{$hospital->contact1}}">
                     ...
                     <div class="media">
                        <a href="https://api.whatsapp.com/send?phone=973{{$hospital->contact2}}">
         ...
         <div class="card-body">
            <div class="tabs-menu ">
               ...
               <ul class="nav nav-tabs profile navtab-custom panel-tabs">
                  ...
                  <li class="">
                     <a href="#stakeholder" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="fas fa-cogs"></i>
                     </span> <span
                        class="hidden-xs">Stakeholder</span> </a>
                  </li>
               </ul>
            </div>
            <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                  ...
                  <div class="row">
                              ...
                              <div class="table-responsive">
                                 <table id="example33" class="table key-buttons text-md-nowrap">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          <td>{{$a->id}}</td>
                                          <td><img src="{{URL::asset('Attachments')}}/{{$hospital->id}}/{{$a->url_logo ?? $a->url_slider}}" style="width: 80px;height: auto"></td>
                                          <td>
                                             <a class="modal-effect btn btn-sm btn-danger"
                                                data-effect="effect-scale"
                                                data-id="{{$a->id}}" data-name="{{$a->url_logo}}"
                                                data-toggle="modal"
                     ...
                     <div class="col-xl-12">
                        <div class="card mg-b-20">
                           <div class="card-header pb-0">
                              <div class="d-flex justify-content-between">
                                 <h4 class="card-title mg-b-0 text-primary">Slider Images</h4>
                              </div>
                              <p class="tx-12 tx-gray-500 mb-2"></p>
                           </div>
                           <div class="card-body">
                              <div class="table-responsive">
                                 <table id="example33" class="table key-buttons text-md-nowrap">
                                    <thead>
                                       <tr>
                                          <th class="border-bottom-0">Id</th>
                                          <th class="border-bottom-0">Slider</th>
                                          <th class="border-bottom-0">Process</th>
                                       </tr>
                                    </thead>
                                    <tbody>
                     ...
                     <div class="col-xl-12">
                        <div class="card mg-b-20">
                           <div class="card-header pb-0">
                              <div class="d-flex justify-content-between">
                                 <h4 class="card-title mg-b-0 text-primary">Contract Provider File</h4>
                              </div>
                              <p class="tx-12 tx-gray-500 mb-2"></p>
                           </div>
                           <div class="card-body">
               ...
               <div class="tab-pane" id="stakeholder">
                  <div class="row">
                     <div class="col-xl-12">
                        <div class="card mg-b-20">
                           <div class="card-header pb-0">
                              <div class="d-flex justify-content-between">
                                 <h4 class="card-title mg-b-0 text-primary">Stakeholder List File</h4>
                              </div>
                              <div class="d-flex justify-content-between float-right">
                                 <a class="modal-effect btn btn-md btn-outline-primary"
                                    data-effect="effect-scale"
                                    data-id="{{$hospital->id ?? ''}}" data-name="{{$hospital->name ??' '}}"
                                    data-toggle="modal"
                                    href="#modaldem11233" title="Services"><i class="fas fa-plus"></i></a>
                              </div>
                              <p class="tx-12 tx-gray-500 mb-2"></p>
                           </div>
                           <div class="card-body">
                              <div class="table-responsive">
                                 <table id="example1" class="table key-buttons text-md-nowrap">
                                    ...
                                    <tbody>
                                       @foreach(\App\hospital_contact::where('hospital_id',$hospital->id)->get()->all() as $h)
                                       <tr>
                                          <td>{{$h->id ?? ' '}}</td>
                                          <td>{{$h->name ?? ' '}}</td>
                                          <td>{{$h->email ?? ' '}}</td>
                                          ...
                                          <td>
                                             <a class="modal-effect btn btn-sm btn-danger"
                                                data-effect="effect-scale"
                                                data-toggle="modal"
                                                href="#modaldem{{$h->id}}" title="delete"><i class="las la-trash"></i></a>
                                             <a class="modal-effect btn btn-sm btn-primary"
                                                data-effect="effect-scale"
                                                data-toggle="modal"
                                                href="#modalde{{$h->id}}" title="edit"><i class="las la-edit"></i></a>
                                          </td>
                                       </tr>
                                       {{--update--}}
                                       <div class="modal" id="modalde{{$h->id}}">
                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                             <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                   <h6 class="modal-title">Edit Stakeholder</h6>
                                                   <button aria-label="Close" class="close" data-dismiss="modal"
                                                      type="button"><span aria-hidden="true">&times;</span></button>
                                                </div>
                                                <form action="{{route('update.hospital.contact')}}" method="post">
                                                   @csrf
                                                   <div class="modal-body row">
                                                      <input type="hidden" name="id_inp" value="{{$h->id}}" id="id_inp">
                                                      <div class="col-6">
                                                      ...
                                                      <div class="col-6">
                                                         ...
                                                         <input type="text" class="form-control" name="job" value="{{$h->job}}">
                                                      </div>
                                                      <div class="col-6">
                                                         <label class="lable">Email</label>
                                                         <input type="email" class="form-control" name="email" value="{{$h->email}}">
                                                      </div>
                                                      <div class="col-6">
                                                         <label class="lable">Phone</label>
                                                         <input type="tel" value="{{$h->phone}}" max="12" class="form-control" name="phone">
                                                      </div>
                                                   </div>
                                       ...
                                       {{--delete--}}
                                       <div class="modal" id="modaldem{{$h->id}}">
                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                             <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                   <h6 class="modal-title">Delete Stakeholder</h6>
                                                   <button aria-label="Close" class="close" data-dismiss="modal"
                                                      type="button"><span aria-hidden="true">&times;</span></button>
                                                </div>
                                                <form action="{{route('delete.hospital.contact')}}" method="post">
                                                   @csrf
                                                   <div class="modal-body">
                                                      <p>Are you sure of the deleting process ?</p>
                                                      <br>
                                                      <input type="hidden" name="id_inp" id="id_inp" value="{{$h->id}}">
                                                      <input class="form-control" name="name_inp" id="name_inp" type="text" value="{{$h->name}}" readonly>
                                                   </div>
                                                   <div class="modal-footer">
                                                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<div class="modal" id="modaldemo99">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content modal-content-demo">
         <div class="modal-header">
            <h6 class="modal-title">Edit Hospital</h6>
            ...
            <div class="modal-body">
               <div class="row bg-purple  text-white mb-2" >
                  <div class="col-lg-6 mb-3 pb-2">
                     ...
                     <select class="form-control select2" name="provider_name2">
                        <option value="{{$hospital->provider_type}}">
                  ...
                  <div class="col-lg-6 mb-3 pb-2">
                     ...
                     <select class="form-control select2" name="card_type">
                        <option value="{{$hospital->card_type}}">
                           {{$hospital->Card->name}}
                        </option>
               ...
               <div class="row">
                  <div class="col-lg-6">
                     ...
                     <input type="date" class="form-control" value="{{$hospital->contract_date}}" name="contract_date">
                     <input type="hidden" value="{{$hospital->id}}" class="form-control" name="id">
                  </div>
                  <div class="col-lg-6">
                     <label class="label">Expiry Date</label>
                     <input type="date" value="{{$hospital->expiry_date}}" class="form-control" name="expiry_date">
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-6">
                     <label class="labe mt-2 ">Provider Name</label>
                     <input type="text" value="{{$hospital->name}}" class="form-control" name="provider_name">
                  </div>
                  <div class="col-lg-6">
                     <label class="labe mt-2 ">*Arabic*</label>
                     <input type="text" class="form-control" value="{{$hospital->name_ar}}" name="provider_name_ar">
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-12">
                     <label class="label mt-2">CR No</label>
                     <input type="text" class="form-control" value="{{$hospital->cr_no}}" name="cr_no">
                  </div>
                  <div class="col-lg-6">
                     <label class="label mt-2">Place</label>
                     <input type="text" class="form-control" value="{{$hospital->place}}" name="place">
                  </div>
                  <div class="col-lg-6">
                     <label class="label mt-2">*Arabic*</label>
                     <input type="text" class="form-control" value="{{$hospital->place_ar}}" name="place_ar">
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-6">
                     <label class="label mt-2">Contact 1</label>
                     <input class="form-control" value="{{$hospital->contact1}}" id="contact" name="contact" type="tel">
                  </div>
                  <div class="col-lg-6">
                     <label class="label mt-2">Contact 2</label>
                     <input class="form-control" value="{{$hospital->contact2}}" id="contact" name="contact2" type="tel">
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-12">
                     ...
                     <div class="input-group mb-3">
                        ...
                        <input aria-describedby="basic-addon1" name="email" class="form-control"
                           placeholder="Email" value="{{$hospital->email}}" type="email">
                     </div>
                     <!-- input-group -->
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-6">
                     ...
                     <input class="form-control" id="Address" value="{{$hospital->address}}" name="address" type="text">
                  </div>
                  <div class="col-lg-6">
                     <label class="label mt-2">*Arabic*</label>
                     <input class="form-control" id="Address" value="{{$hospital->address_ar}}" name="address_ar" type="text">
                  </div>
                  <div class="col-lg-12">
                     <label class="label mt-2">Website</label>
                     <input class="form-control" id="Website" name="website" value="{{$hospital->website}}" type="text">
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-lg-12">
                     ...
                     <select class="form-control select2" name="category">
                        ...
                        <option value="{{$c->id}}" {{ $c->id == $hospital->category_id ? 'selected' : ''}}>
                              {{$c->category}} - {{$c->category_ar}}
                        </option>
                        @endforeach
                     </select>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     ...
                     <textarea class="form-control"  name="description_ar"
                        rows="3">{{$hospital->description_ar}}</textarea>
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-12">
                     ...
                     <textarea class="form-control"  name="comment" placeholder="Comment"
                        rows="3">{{$hospital->comment}}</textarea>
                  </div>
               </div>
               <div class="modal-footer">
...
<div class="modal" id="modaldem11233">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content modal-content-demo">
         <div class="modal-header">
            <h6 class="modal-title">Add Stakeholder</h6>
            <button aria-label="Close" class="close" data-dismiss="modal"
               type="button"><span aria-hidden="true">&times;</span></button>
         </div>
         <form action="{{route('add.hospital.contact')}}" method="post">
            @csrf
            <div class="modal-body row">
               <input type="hidden" name="id_inp" value="{{$hospital->id}}" id="id_inp">
               <div class="col-6">
                  <label class="lable">Name</label>
               ...
               <div class="col-6">
                  <label class="lable">Phone</label>
                  <input type="tel" max="12" class="form-control" name="phone">
               </div>
            </div>
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content modal-content-demo">
         ...
         <form action="{{route('edit_status_online')}}" method="post">
            @csrf
            <div class="modal-body">
               <p>Do you want to change status Online ?</p>
               <br>
               <input type="hidden" value="{{$hospital->id}}" name="id_inp" id="id_inp">
               <select class="form-control select2" name="on_off">
               <option {{ ($hospital->on_off == "0") ? "selected" : "" }} value="0">
               Offline
               </option>
               <option {{ ($hospital->on_off == "1") ? "selected" : "" }} value="1">
               Online
               </option>
               </select>
            </div>
         ...
         <form action="{{route('save_attachment')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
               <div class=" col-lg-12">
                  ...
                  <input type="hidden" value="{{$hospital->id}}" name="id_inp">
...
{{--Gallery--}}
<div class="modal" id="modaldemlo001">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content modal-content-demo">
         <div class="modal-header">
         ...
         <form action="{{route('save_attachment_gallery')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
               <div class="col-sm-12 col-md-4 col-lg-12">
                  <label class="label mt-2">Gallery</label>
                  <input type="hidden" value="{{$hospital->id}}" name="id_inp">
                  <input type="file" class="dropify" data-height="70" multiple name="file_name[]"/>
               </div>
            </div>
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
