...
@endsection
@section('page-header')
    <form action="{{route('profile_update_plus')}}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- breadcrumb -->
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">Cards</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/<i style="color: goldenrod;font-weight: bold">Edit-Profile Plus</i></span>
                </div>
            </div>
                                ...
                                <div class="main-profile-overview">
                                    ...
                                    <div class="d-flex justify-content-between row mg-b-20">
                                        <div class="col-lg-12">
                                            ...
                                            <a href="{{url('profile_plus')}}/{{$father_name->father_id ?? $card->cpr_no}}">{{$father_name->name ?? 'himself
'}}</a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content border-left border-bottom border-right border-top-0 p-4"
                                ...
                                <div class="tab-pane active" id="home">
                                    ...
                                    <div class="panel-group1" id="accordion11">
                                        <div class="panel panel-default  mb-4">
                                            <div class="panel-heading1" style="background-color:goldenrod;">
                                    ...
                                    <div class="btn-group float-left">
                                        ...
                                        <a href="{{route('invoice_index_print_plus',$card->cpr_no)}}"
                                                ...
                                                <table class="table text-md-nowrap" id="example1">
                                                    ...
                                                    @foreach($card_father as $c)
                                                        <tr>
                                                            <td>{{$c->id}}</td>
                                                            <td>
                                                                <a href="{{route('profile_show_plus',$c->cpr_no)}}">{{$c->name}}</a>
                                                            </td>
                                                            <td>{{$c->cpr_no}}</td>
                                                            <td>
                                                                @can('card status')
                                                                ...
                                                                <div class="dropdown dropup">
                                                                    ...
                                                                    <div class="dropdown-menu tx-13">
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                           href="{{route('profile_show_plus',$c->cpr_no)}}"
                                                                           data-effect="effect-scale"
                                ...
                                <div class="tab-pane" id="allcard">
                                    <div class="row">
                                        <div class="col-lg-4"><a
                                                href="{{route('single_card_plus',['id'=>$card->cpr_no,'id2'=>2])}}"
                                    ...
                                    @foreach($card_father as $f)
                                        ...
                                        <div class="row" id="print">
                                            ...
                                            <div class="col-lg-2">
                                                <a href="{{route('single_card_plus',['id'=>$f->cpr_no,'id2'=>0])}}"
                                ...
                                <div class="tab-pane" id="allcarddesing">
                                    <div class="row">
                                        <div class="col-lg-4"><a
                                                href="{{route('single_card_plus',['id'=>$card->cpr_no,'id2'=>3])}}"
                                                class="btn btn-primary float-left mt-3 mr-2">
                                                <i class="mdi mdi-printer ml-1"></i>Print All
                                            </a>
                                        </div>
                                    ...
                                    @foreach($card_father as $f)
                                        ...
                                        <div class="row" id="print">
                                            ...
                                            <div class="col-lg-2">
                                                <a href="{{route('single_card_plus',['id'=>$f->cpr_no,'id2'=>1])}}"
                                                   class="btn btn-danger float-left mt-3 mr-2">
                                                    <i class="mdi mdi-printer ml-1"></i>Print
                                                </a>
                                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><a href="{{route('profile_invoice_show_all_plus',$card->cpr_no)}}"
    ...
    <div class="modal" id="modaldem">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{route('delete_card_plus')}}" method="post">
                    @csrf
    ...
    <div class="modal " id="modaldem2">
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="post" action="{{route('add_cards_user_more_plus')}}" enctype="multipart/form-data">
                    @csrf
...
@section('js')
    ...
    <script>
        ...
        function editStatus(a, c) {
            ...
            $.ajax({
                type: 'get',
                url: "{{url::to('profile/package_name_plus')}}" + '/' + user_id + '/' + mySelect,
    ...
    <script>
        ...
        function editData(a, b, c) {
            ...
            $.ajax({
                type: 'get',
                url: "{{url::to('profile/package_prices_plus')}}" + '/' + mySelect + '/' + user_id,
                success: function (data) {
                    b.value = data;
                    notif({
    ...
    <script>
        ...
        function balance(a, c) {
            ...
            $.ajax({
                type: 'get',
                url: "{{url::to('profile/balance_plus')}}" + '/' + mySelect + '/' + user_id,
                success: function (data) {
                    a.value = data;
                    notif({
  ...
  <script>
        ...
        function delivery(a, c ,b) {
            ...
            $.ajax({
                type: 'get',
                url: "{{url::to('profile/delivery_plus')}}" + '/' + mySelect + '/' + user_id +'/' + cpr_no,
                success: function (data) {
                    total.value = data;
                    notif({
    ...
    <script>
        ...
        function editPackagePrice(a, c) {
            ...
            $.ajax({
                type: 'get',
                url: "{{url::to('profile/editPackagePrice_plus')}}" + '/' + mySelect + '/' + user_id,
                success: function (data) {
                    a.value = data;
                    notif({
