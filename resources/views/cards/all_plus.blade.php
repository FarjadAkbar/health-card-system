...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Cards</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0 ">/  <i style="color: goldenrod;font-weight: bold">All Plus Cards</i></span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="mb-3 mb-xl-0">
                   ...
                   <div class="btn-group">
                        <a href="{{route('show_plus_draft',1)}}" style="background-color: goldenrod;font-weight: bold; color: white" class="btn" title="online card">
                            Online Cards
                        </a>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table key-buttons text-md-nowrap tr"
                            ...
                            @foreach($card as $c)
                                <tr>
                                    <td></td>
                                    <td><a href="{{route('profile_show_plus',$c->cpr_no)}}"> {{$c->name}}</a></td>
                                    <td>{{$c->cpr_no}}</td>
                                    ...
                                    <td>
                                            <a class=" btn btn-sm btn-info" href="{{route('profile_show_plus',$c->cpr_no)}}"
