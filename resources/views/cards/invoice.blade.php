										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												<tr>
                                                    ...
                                                    @else
                                                        <td class="" style="font-weight: bold;font-size: 19px;color: black;text-decoration: underline;text-decoration-style:solid;text-decoration-thickness:0.2em;  ">
                                                            {{ (int) $invoice->price + (int) $invoice->delivery ?? 0}}  BD
                                                    </td>
