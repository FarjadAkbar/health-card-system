...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Cards</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ All Group Card</span>
            </div>
        </div>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">All Group Card</h4>
                    ...
                    <div class="table-responsive">
                        <table id="allcarddata" class="table key-buttons text-md-nowrap tr"
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0 text-white">CR</th>
