            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">All Customers {{$status}} Card</h4>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="carddata" class="table key-buttons text-md-nowrap tr"
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0 text-white" width="70">Status</th>
