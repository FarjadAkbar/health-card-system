        ...
        <div class="breadcrumb-header justify-content-between">
            ...
            <div class="d-flex my-xl-auto right-content">
                <div class="mb-3 mb-xl-0">
                    ...
                    <div class="btn-group">
                        <a class="modal-effect btn btn-outline-secondary" data-effect="effect-super-scaled"
                        data-toggle="modal" href="#modalmessage">Send Message</a>
                    </div>
...
<div class="btn-group">
                            <a class="modal-effect btn  btn-outline-info"
                               data-toggle="modal"
                               href="#historymodal" title="events history"><i class="fas fa-users"></i> View History</a>
                        </div>
                    @endif
                                ...
                                <div class="main-profile-overview">
                                    ...
                                    <div class="d-flex justify-content-between row mg-b-20">
                                        <div class="col-lg-12">
                                            ...
                                            <a href="{{url('profile')}}/{{$father_name->father_id ?? $card->cpr_no}}">{{$father_name->name ?? 'himself'}}</a>
                                    ...
                                    <div class="main-profile-social-list">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <span>{{ $card->group_company && $card->cpr_no == $card->father_id ? 'CP NO.' : 'CPR NO.'}}</span><input type="number" class="form-control" name="cpr"
                                                                           value="{{$card->cpr_no ?? ' '}}">
                                            </div>
                                        </div>
                                        <div class="media">
                                ...
                                <ul class="nav nav-tabs profile navtab-custom panel-tabs">
                                    <li class="active">
                                        <a href="#home" data-toggle="tab" aria-expanded="true"> <span
                                                class="visible-xs"><i class="fas fa-user-check text-purple"></i></span>
                                            <span
                                    ...
                                    @if($card->status == 'paid' || $card->status == 'done')
                                        ...
                                        <li class="">
                                            <a href="#allcarddesing" data-toggle="tab" aria-expanded="false"> <span
                                                    class="visible-xs"><i class="fas fa-drafting-compass"></i></span>
                                                <span
                                                ...
                                                <div class="panel-body border">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3  mg-t-10 mg-md-t-0">
                                                            ...
                                                            <input type="text" onchange="sum();" name="delivery"
                                                                   id="delivery" class="form-control mb-1"
                                                                   value="{{$card->delivery ??  ' '}}">
                                                        </div>
                                                        ...
                                                        <div class="col-lg-12 mg-t-10 mg-md-t-0">
                                                            ...
                                                            <input type="file" id="id_service_image" class="dropify"
                                                                   name="customer_img" value="{{$card->img}}"
                                                                   data-height="90"
                                                                   data-default-file="{{ URL::to('customer_img')}}/{{$card->cpr_no ?? ''}}/{{$card->img ?? ''}}"/>
                                                        </div>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropup">
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                           href="{{route('profile_invoice_show_specific', ['id' => $c->father_id, 'id2' => $c->cpr_no ])}}"
                                                                           data-effect="effect-scale"
                                                                           title="print"><i class="mdi mdi-printer"></i> Print Invoice</a>
                                        ...
                                        @foreach($card_father as $f)
                                            ...
                                            <div class="row" id="print">
                                                ...
                                                <div class="col-lg-8" style="background-color: white">
                                                    ...
                                                    <div class="row align-items-center justify-content-center" style="height:330px;">
                                                        <div class="{{ $card->group_company && \App\Card::where('cpr_no', $card->father_id)->first()->img != '' ? 'col-lg-3' : 'col-lg-1'}}">
                                                        @if($card->group_company && \App\Card::where('cpr_no', $card->father_id)->first()->img != '')
                                                                <img src="{{ URL::to('customer_img')}}/{{$card->cpr_no}}/{{$card->img}}" alt=""  width="50">
                                                            @endif
                                                            </div>
                                                        <div class="col-lg-7" >
                                    ...
                                    @else
                                            ...
                                            <div class="row" id="print">
                                                ...
                                                <div class="col-lg-8" style="background-color: white">
                                                    ...
                                                    <div class="row align-items-center justify-content-center" style="height:330px; ">
                                                            <div class="{{ $card->group_company && \App\Card::where('cpr_no', $card->father_id)->value('img') != '' ? 'col-lg-3' : 'col-lg-1'}}">
                                                        @if($card->group_company && \App\Card::where('cpr_no', $card->father_id)->value('img') != '')
                                                                <img src="{{ URL::to('customer_img')}}/{{$card->father_id}}/{{\App\Card::where('cpr_no', $card->father_id)->first()->img}}" alt="" height="100" width="90">
                                                        @endif
                                                            </div>
                                                        <div class="col-lg-7">
                                ...
                                @if($card->father_id == $id)
                                    ...
                                    @foreach($card_father as $f)
                                        ...
                                        <div class="row" id="print">
                                            ...
                                            <div class="col-lg-8"
                                                ...
                                                <div class="row align-items-center justify-content-center" style="height:330px; ">
                                                        <div class="{{ $card->group_company && \App\Card::where('cpr_no', $card->father_id)->first()->img != '' ? 'col-lg-3' : ''}}">
                                                    @if($card->group_company && \App\Card::where('cpr_no', $card->father_id)->first()->img != '')
                                                                <img src="{{ URL::to('customer_img')}}/{{$card->cpr_no}}/{{$card->img}}" alt=""  width="50">
                                                            @endif
                                                            </div>
                                    ...
                                    <div class="row" id="print">
                                            ...
                                            <div class="col-lg-8"
                                                ...
                                                <div class="row align-items-center justify-content-center" style="height:330px; ">
                                                        <div class="{{ $card->group_company && \App\Card::where('cpr_no', $card->father_id)->value('img') != '' ? 'col-lg-3' : ''}}">
                                                    @if($card->group_company && \App\Card::where('cpr_no', $card->father_id)->value('img') != '')
                                                                <img src="{{ URL::to('customer_img')}}/{{$card->father_id}}/{{\App\Card::where('cpr_no', $card->father_id)->first()->img}}" alt="" height="100" width="90">
                                                            @endif
                                                            </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">CP No.</th>
                            ...
                            <tr>
                                    <td>
                                        <select class="form-control select1 mb-1" name="status_ajax{{$card->id}}"
                                                onchange="editData(this,package_prices{{$card->id}},{{$card->id}})">
                                            <option value="{{$card->package_type}}">
                                                {{$card->Package->name ??''}}
                                            </option>
                                            @foreach($package as $p)
                                    ...
                                    <td>
                                        <select class="form-control select1 mb-1" name="status"
                                                onchange="editStatus(this,{{$card->id}})">
                                            <option value="{{$card->status}}" selected disabled>{{$card->status}}</option>
                                    ...
                                    <td><input type="text" value="{{$card->price}}" class="form-control" onchange="editPackagePrice(this,{{$card->id}});"
                                               id="package_prices{{$card->id}}"></td>
...
<form action="{{route('profile_invoice_show_all', $card->cpr_no)}}" method="post">
    @csrf
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                            <tr>
    ...
    <div class="modal " id="modaldem2">
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form method="post" action="{{route('add_cards_user_more')}}" enctype="multipart/form-data">
                    @csrf
...
{{--contract--}}
    <div class="modal" id="modaldemlo12234">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{route('card_company_import')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="col-sm-12 col-md-4 col-lg-12">
                            <label class="label mt-2">File Import</label>
                            <input type="file" class="dropify" data-height="70" name="import" accept=".xlsx, .xls, .csv"/>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal " id="historymodal">
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">History For All Events</h6>
                    <button aria-label="Close" class="close" data-dismiss="modal"
                            type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body" style="background-color: whitesmoke">
                <table class="table text-md-nowrap w-100" id="example">
                            <thead>
                            <tr>
                                <th class="wd-15p border-bottom-0">Id</th>
                                <th class="wd-15p border-bottom-0">Event</th>
                                <th class="wd-15p border-bottom-0">New Expiry</th>
                                <th class="wd-15p border-bottom-0">Last Expiry</th>
                                <th class="wd-15p border-bottom-0">Action By</th>
                            </tr>
                            </thead>
                            <tbody>
    ...
    <div class="modal" id="modalmessage">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Send Custom Message</h6>
                    <button aria-label="Close" class="close" data-dismiss="modal"
                            type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2" action="{{url('/mails/new/save')}}" method="post">
                    ...
                    <input name="template" type="hidden" value="0">
                    <input name="sent_to" type="hidden" value="specific">
                    
                    <input name="card_type" type="hidden" value="{{$card->group_company ? 'group_card' : 'health_card'}}">
                    <input name="selected_specific_emails" type="hidden" value="{{$card->email != '' ? $card->email : 'test@gmail.com'}}">
