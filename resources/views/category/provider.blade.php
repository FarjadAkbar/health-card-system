                                ...
                                <div class="table-responsive">
                                    <table class="table text-md-nowrap" id="example1">
                                        ...
                                        <tr>
                                            <td>{{$p->id}}</td>
                                            <td>{{$p->name}}</td>
                                            <td><i class="fas fa-circle" style="color: {{$p->color}}"></td>
                                            <td>
                                                    ...
                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                       data-id="{{$p->id}}" data-name="{{$p->name}}" data-ar="{{$p->name_ar}}" data-color="{{$p->color}}"
                                                       data-toggle="modal"
                                                       href="#modaldemlo1245"
                        ...
                        <div class="modal-content modal-content-demo">
                            ...
                            <form action="{{route('category.provider.add')}}" method="post">
                                ...
                                <div class="modal-body ">
                                    ...
                                    <label class="status bold">Provider Name_AR</label>
                                    <input type="text" name="provider_name_ar" class="form-control">

                                </div>
                                <div class="modal-body ">

                                    <label class="status bold">Provider Color</label>
