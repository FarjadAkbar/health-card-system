                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1" style="background-color:#761193;">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0 text-white">status_user</th>
                                <th class="wd-15p border-bottom-0 text-white">status_staff</th>
                                        ...
                                        <td>
                                                <a class="modal-effect btn btn-sm btn-danger"
                                                   ...
                                                   href="#modaldem" title="delete"><i class="las la-trash"></i></a>
                                                    ...
                                                    <a class="modal-effect modal-smE btn btn-sm btn-success"
                                                       data-effect="effect-scale"
                                                       data-id="{{$c->id}}" data-name="{{$c->name}}"
                                                       data-toggle="modal"
                                                       href="#modaldem22" title="staff_status"><i class="las la-edit"></i></a>

                                                <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                   data-id="{{$c->id}}" data-name="{{$c->name}}"
                                                   data-description="{{$c->package_prices}}"
                                                   data-toggle="modal"
                                                   href="#modaldemlo1245"
    ...
    <div class="modal" id="modaldem22">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{route('show_PackageType_edit_staff')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden"  name="id_staff">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <label class="label mt-2">Staff-Status</label>
                            <select class="form-control select2"  name="status_staff">
                                <option label="Choose one">
                                </option>
                                <option value="0">
                                    Offline
...
@section('js')
    ...
    <script type="text/javascript">
        $('#modaldem22').on('show.bs.modal', function (e) {
            ...
            $(e.currentTarget).find('input[name="id_staff"]').val(id);
        });
    </script>
    <script type="text/javascript">
