...
<div class="col-lg-8 content-area" style="background-color: white">
...
<div class="col-sm-12">
    <div class="ttm-service-description">
        <h4>{{trans('main_tran.Search The Directory Of Existing')}}: </h4>
        ...
        @if(!isset($hospital_search))
            <div class="row">
                ...
                <div class="col-6" >
                    <!-- featured-iconbox -->
                    <div class="featured-icon-box icon-align-top-content box-shadow style1" style="background-color: {{$p->color}};height: 100px">

                        <div class="featured-content text-center">
                            <a href="{{route('hospital.directory.all.plus',$p->id)}}">
                                @if(App::getLocale()== 'en')
                            <div class="featured-title">
                                <h6 style="color: white;font-size: 18px">{{$p->name}}</h6>
                            </div>
                            @else
                            <div class="featured-title">
                                <h6 style="color: white;font-size: 18px">{{$p->name_ar}}</h6>
                            </div>
                            @endif
                            </a>
                        </div>
...
<li class="active"><a href="{{route('hospital.directory',1)}}">{{trans('main_tran.Medical Directory')}}</a></li>
